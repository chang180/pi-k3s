...
4. **新增** [k8s/namespace.yaml](k8s/namespace.yaml)
   - 建立 namespace，例如 `pi-k3s`。

5. **新增** [k8s/deployment.yaml](k8s/deployment.yaml)
